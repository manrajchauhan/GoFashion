...
export default function Hero() {
  return (
    <div
      ...
      style={{background: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/hero2.webp')", backgroundSize: "cover"}}
    >
      <div className="pt-[200px] pb-10 items-center text-center">
        <h1 className="tracking-tight text-4xl md:text-6xl text-white font-medium mb-6">
