        ...
        {projects.map((project) => (
          <div key={project.id} className="w-full max-w-xs mx-auto">
            <img
              src={project.image}
              alt={project.name}
              className="w-full h-60 border object-cover rounded-xl hover:scale-105 transition-transform duration-200"
            />
            <div className="mt-4">
              <h2 className="text-lg font-semibold text-neutral-700">{project.name}</h2>
