...
const DemoImgs = {
  img1:{
    ...
    name: 'Women - Gorgeous',
    description: 'Deleted on 12/12/2021',
  },
...
export default function TrashPage() {
  return (
    <div className="p-6 w-full bg-white rounded-2xl max-md:px-4 max-md:max-w-full mt-4 min-h-screen">
      <h1 className="text-4xl font-bold text-neutral-700 mb-6 tracking-tighter">Trash</h1>
      <div className="flex flex-wrap gap-4">
        Delete your files here to remove them from your account.
        </div>
